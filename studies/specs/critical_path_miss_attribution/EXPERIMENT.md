...
- [critical_path_serial_resume.jsonl](/Users/tejguntuku/TEJ/CS_Independent_Research/kv_cache_research/datasets/synthetic/headroom_studies/critical_path_miss_attribution/critical_path_serial_resume.jsonl)

Near-real workload:

- [critical_path_miss_attribution\_\_realworld_sequence.jsonl](/Users/tejguntuku/TEJ/CS_Independent_Research/kv_cache_research/datasets/processed/headroom_studies/critical_path_miss_attribution/critical_path_miss_attribution__realworld_sequence.jsonl)
...
python3 benchmarking/runners/run_critical_path_miss_attribution.py \
  ...
  --output-root studies/results/headroom_critical_path_pilot \
  --mode pilot
```
...
python3 benchmarking/runners/run_critical_path_miss_attribution.py \
  --model-path Qwen/Qwen2.5-7B-Instruct \
  --output-root studies/results/headroom_critical_path_full \
  --mode full
```
